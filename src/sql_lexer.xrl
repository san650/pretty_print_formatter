...
KEYWORDS   = (ALL|AND|ANY|AS|ASC|BY|CONFLICT|DELETE|DESC|DISTINCT|DO|FALSE|FROM|GROUP|INNER|INSERT|INTO|IS|JOIN|LEFT|LIMIT|NULL|ON|OR|ORDER|OUTER|RECURSIVE|RETURNING|SELECT|SET|TRUE|UNION|UPDATE|VALUES|WITH|WHERE)
INT        = [0-9]+
NAME       = [a-z0-9"_.]+
WHITESPACE = [\s\t\n\r]
SEPARATOR  = ,
