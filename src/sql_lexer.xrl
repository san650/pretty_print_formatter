...
KEYWORDS   = (AND|ANY|AS|ASC|BY|CONFLICT|DELETE|DESC|DISTINCT|DO|FALSE|FROM|INNER|INSERT|INTO|IS|JOIN|LEFT|LIMIT|NULL|ON|OR|ORDER|OUTER|RETURNING|SELECT|SET|TRUE|UPDATE|VALUES|WHERE)
INT        = [0-9]+
NAME       = [a-z0-9"_.]+
WHITESPACE = [\s\t\n\r]
SEPARATOR  = ,
